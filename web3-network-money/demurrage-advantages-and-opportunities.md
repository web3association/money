...
If someone receives interest from simply holding or staking the network coin there is a strong likelihood that inequality in coin ownership will increase over time. Any form of storable Web3 money is able to generate positive and risk free interest due either staking rewards or from lending it out in a single asset borrowing and lending protocol. The amount of interest they would earn could vary however it would be a positive rate of return.

Let’s consider a 1% interest rate. A person holding $1 million worth of the network coin would receive $10,000 in interest each year. If they are able to live off less than that amount they reach escape velocity where they can perpetually increase their money position each year without contributing anything else to the economy. Demurrage prevents this likely inevitability as instead of gaining 1% each year they would be losing 1%. Now instead of reaching escape velocity it instead gets harder and harder to retain large amounts of the network coin over the long term due to the loss from demurrage. A positive interest rate for holding or using the network coin in a risk free manner is an example of unearned income - someone would be receiving income without contributing anything else to the economy. Demurrage helps to reduce these issues around unearned income and reduce the possibility of inequality over the long term.
...
Demurrage incentivises people to exchange or invest their money rather than leave it idle. This can help with increasing the amount of coin dispersion across the network, which is highly beneficial for a Web3 network for preventing the concentration of coin ownership over the long term. The network coin is commonly used to determine someone's voting power when participating in governance decisions, such as a network parameter change. Decentralisation of coin ownership is highly useful in these contexts as it would help with improving the security of the network. Decentralised ownership means the power to influence the network's operational parameters is distributed across more people. Even a small rate of demurrage can help to ensure that coins won’t easily consolidate into the hands of a few people as the cost of holding a large amount of coins idle increases proportionally with the number of coins being held.
...
The income generated by a network coin tax would be reliable and predictable for funding ecosystem initiatives that introduce new use cases or that improve the network's infrastructure. Even a small percentage tax rate could generate a meaningful amount of income that helps to maintain and improve a Web3 network. Network coin taxes would be charged periodically, such as every day, and would only collect a very small percentage amount. Over a year the aggregate taxation value collected would represent the annual percentage tax rate. The exact amount of income should be known ahead of time due to it coming from the existing supply. The predictability of the taxation income is beneficial for ecosystem funding as it can be taken into account when planning and funding any larger initiatives. Ecosystem funding could create a positive flywheel for improving and growing the network. The better the return on investment is for funding ecosystem initiatives the faster the price of the network coin could appreciate. More coin price appreciation means the same network coin tax can pay for even more ecosystem initiatives. This growth flywheel could keep repeating until the network is globally adopted.



**Accelerate ecosystem growth**

The network coin tax could dramatically help with increasing the ecosystem's rate of growth. The founding entities first need to prove that the funding process they develop is sufficiently effective at improving, maintaining and growing the ecosystem. If the return on investment from the funding process is higher than the cost it would likely be beneficial to increase the tax rate. The higher the coin tax rate the larger the amount of income that will be generated for the treasury that can then be used for funding more ecosystem initiatives. Holders of the network coin might lose more coins from the network coin tax but they could benefit from much faster coin price appreciation due to the initiatives that get developed due to the funding process. Web3 networks operate in highly competitive markets, so increasing the growth rate of the ecosystem would likely be highly desirable due to the opportunity of rapidly increasing any network effects faster than the competition.
